...
export interface DropdownHandlers {
	...
	closeDropdown: () => void;
	setupOutsideClickHandler: (isOpen: boolean, containerRef: HTMLElement, callback: () => void) => (() => void) | undefined;
 ...
 */
export function createDropdownHandlers({ isOpen, setIsOpen, isMobile = false, containerRef, toggleCallback, closeCallback }: { isOpen: boolean; setIsOpen: (value: boolean) => void; isMobile?: boolean; containerRef: HTMLElement | null; toggleCallback?: (isOpen: boolean) => void; closeCallback?: () => void }): DropdownHandlers {
