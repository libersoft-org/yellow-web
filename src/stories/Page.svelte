...
<article>
	<Header onCreateAccount={() => (user = { name: 'Jane Doe' })} onLogin={() => (user = { name: 'Jane Doe' })} onLogout={() => (user = undefined)} {user} />

	<section class="storybook-page">
		<h2>Pages in Storybook</h2>
		<p>
			We recommend building UIs with a
			<a href="https://blog.hichroma.com/component-driven-development-ce1109d56c8e" rel="noopener noreferrer" target="_blank">
