 ...
 <Tbody>
  {#each core as c}
   <TbodyTr>
    ...
    <Td>
     <div class="icon">
      <img src="img/{state[c.implemented].icon}" alt={state[c.implemented].name} />
     </div>
    </Td>
   </TbodyTr>
  {/each}
 ...
 <Table>
  ...
  <Tbody>
   {#each m.features as f}
    <TbodyTr>
     <Td><span class="bold">{f.name}</span></Td>
     <Td>
      <div class="icon">
       <img src="img/{state[f.implemented].icon}" alt={state[f.implemented].name} />
      </div>
     </Td>
    </TbodyTr>
   {/each}
