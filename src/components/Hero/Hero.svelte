...
{#snippet rightSide()}
	<div class="flex justify-center items-center h-full mb-10 md:mb-0">
		<img src={imageSrc} alt="Yellow app on multiple devices" class="max-w-full h-auto" />
	</div>
{/snippet}

<div class="relative mb-20 pt-24.5 pb-9 md:pt-35 md:pb-8 lg:pt-46 lg:pb-13 bg-cover bg-center isolate" style="background-image: url('{backgroundImage}')">
