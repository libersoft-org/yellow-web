...
<div class="mx-auto w-full">
  ...
  <div class="bg-themeYellow-600 w-full max-w-[620px] rounded-xl p-6 drop-shadow-md md:p-10 lg:p-12.5">
    <form onsubmit={handleSubmit}>
      ...
      <div class="mb-4">
        <label for="formSelect" class="text-themeGray-800 mb-1.5 block text-xl font-medium">Selectbox</label>
        <SelectBox
          id="formSelect"
      ...
      <div class="mb-4">
        <fieldset>
          <legend class="text-themeGray-800 mb-1.5 block text-xl font-medium">Options</legend>
