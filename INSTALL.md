...
source /root/.bashrc
git clone https://github.com/libersoft-org/yellow-web.git
cd yellow-web/
bun i
```
...
... and then navigate to: https://YOUR_SERVER_ADDRESS:7000/ in your browser. Browser will show the certificate error, just skip it.
